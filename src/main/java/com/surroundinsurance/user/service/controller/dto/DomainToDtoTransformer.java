...
public class DomainToDtoTransformer {
	...
	public static TokenVerificationRS transformUserToTokenVerificationRS(
		...
		if (userAuthenticationToken.getUserPermissions() != null
			...
			for (com.surroundinsurance.user.service.domain.user.UserPermission userPermission : userAuthenticationToken
					.getUserPermissions()) {
	...
	public static UserProfileRS transformUserToUserProfileRS(User user) {
		...
		if (user != null) {
			...
			if (user.getAdditionalInformation() != null) {
				for(com.surroundinsurance.user.service.domain.user.AdditionalInformation additionalInformation : user.getAdditionalInformation())
