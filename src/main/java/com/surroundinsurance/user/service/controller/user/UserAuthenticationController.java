package com.surroundinsurance.user.service.controller.user;

import static com.surroundinsurance.user.service.platform.common.CommonConstants.AUTHORIZATION_DATATYPE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.AUTHORIZATION_DESCRIPTION;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.AUTHORIZATION_PARAMTYPE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_METHOD_POST;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_BAD_REQUEST_STATUS_CODE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_BAD_REQUEST_STATUS_DESCRIPTION;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_FORBIDDEN_STATUS_CODE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_FORBIDDEN_STATUS_DESCRIPTION;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_SUCCESS_STATUS_CODE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_SUCCESS_STATUS_DESCRIPTION;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_UNAUTHORIZED_STATUS_CODE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.HTTP_STATUS_UNAUTHORIZED_STATUS_DESCRIPTION;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.INVALID_PARTNER_ID_HEADER;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.PARTNER_ID_DATATYPE;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.PARTNER_ID_DESCRIPTION;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.PARTNER_ID_HEADER;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.PARTNER_ID_NOT_FOUND_HEADER;
import static com.surroundinsurance.user.service.platform.common.CommonConstants.PARTNER_ID_PARAMTYPE;
...
import com.surroundinsurance.user.service.application.UserAuthenticationApplicationService;
...
import com.surroundinsurance.user.service.domain.user.exception.AuthenticationFailedException;
