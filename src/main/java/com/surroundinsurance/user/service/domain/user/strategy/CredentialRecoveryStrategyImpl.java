...
public class CredentialRecoveryStrategyImpl implements CredentialRecoveryStrategy {
	...
	@Value("${user.service.forgot.password.url}")
	private String forgotPasswordUrl;	
	
	/** The forgot password verification code expire time. */
	@Value("${user.service.forgot.password.verification.code.expire.time}")
	...
	@Value("${user.service.user.forgot.password.event.name}")
